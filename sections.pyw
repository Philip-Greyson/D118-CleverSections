                                            ...
                                            for section in sections:
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        cur.execute('SELECT teachers.users_dcid, teachers.first_name, teachers.last_name, roledef.name FROM sectionteacher LEFT JOIN teachers ON sectionteacher.teacherid = teachers.id LEFT JOIN roledef ON sectionteacher.roleid = roledef.id WHERE sectionteacher.sectionid = :section ORDER BY sectionteacher.roleid', section=sectionID)
